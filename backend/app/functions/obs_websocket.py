...
class OBSWebsocketsManager:
    ...
    def __init__(self):
        ...
        self.ws = obsws(dontleak.obs_server_ip, dontleak.obs_server_port, dontleak.obs_server_password)
        try:
            self.ws.connect()
        except:
...
if __name__ == '__main__':
    ...
    obswebsockets_manager.set_source_visibility('Video Cam', "Stream Title", False)
    time.sleep(3)
    obswebsockets_manager.set_source_visibility('Video Cam', "Stream Title", True)
    time.sleep(3)
    ...
    obswebsockets_manager.set_scene('Display')
    time.sleep(3)
    print("Swapping back! \n\n")
    obswebsockets_manager.set_scene('Video Cam')
    ...
    current_text = obswebsockets_manager.get_text("Stream Description")
    print(f"Here's its current text: {current_text}\n\n")

    print("Changing a text source's text! \n\n")
    obswebsockets_manager.set_text("Stream Description", "Here's my new text!")
    time.sleep(3)
    obswebsockets_manager.set_text("Stream Description", current_text)
    time.sleep(1)
    ...
    response = obswebsockets_manager.get_input_settings("Stream Description")
    ...
    response = obswebsockets_manager.get_scene_items('Video Cam')
